...
class ListConcretePumps : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(rootElement) {
            ...
            vehicleRecycler.layoutManager = LinearLayoutManager(this@ListConcretePumps)
        }

        setupAuthGuard {
            mViewModel = initViewModel()
            mViewModel.initConcretePumps()
    ...
    private fun dataItemClick(dataItem: DataVehicles) {
        ...
        intent.putExtra("volumeMixArrow", dataItem.volumeMixArrow)
        intent.putExtra("heightMixArrow", dataItem.heightMixArrow)
